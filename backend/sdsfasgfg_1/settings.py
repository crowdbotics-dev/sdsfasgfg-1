"""
Django settings for sdsfasgfg_1 project.
...
WSGI_APPLICATION = 'sdsfasgfg_1.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "sdsfasgfg_1 API",
    "DESCRIPTION": "API documentation for sdsfasgfg_1 App",
    "VERSION": "v1",
}
